...
import { applyBrainlinkOrganizer } from './apply-brainlink-organizer.mjs';
import { applyBrainlinkWorkspaceShell } from './apply-brainlink-workspace-shell.mjs';
...
export const materializeBrainlink = async options => {
  ...
  applyBrainlinkOrganizer({ sourceRoot, targetRoot: target });
  applyBrainlinkWorkspaceShell({ targetRoot: target });
