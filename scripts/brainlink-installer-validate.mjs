...
check('Governance bridge is durable, live and has no static fallback', materialize.includes('applyAffineGovernanceBridge') && governanceBridge.includes('governance-source.json') && governancePanel.includes('@tanstack/react-query') && governanceStore.includes('/api/governance/snapshot') && governanceStore.includes('Cache-Control') && governancePanel.includes('refetchInterval: 15_000') && governancePanel.includes('GOVERNANCE_UPDATED_EVENT') && !governancePanel.includes('fallbackData'));
